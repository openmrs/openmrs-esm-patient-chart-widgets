...
describe("<MedicationRecord />", () => {
  ...
  it("displays the selected medication correctly", async () => {
    ...
    await wait(() => {
      ...
      expect(
        wrapper.getByText("Substitutions permitted").textContent
      ).toBeTruthy();
      expect(
        wrapper.getByText("Wednesday 19-Feb-2020").textContent
      ).toBeTruthy();
      ...
      expect(
        wrapper.getByText("Total number of refills").textContent
      ).toBeTruthy();
